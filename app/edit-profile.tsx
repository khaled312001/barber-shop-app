    ...
    <View style={[styles.container, { backgroundColor: theme.background }]}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={[styles.content, { paddingBottom: bottomPad + 100 }]}>
        ...
        <View style={[styles.inputContainer, { backgroundColor: theme.inputBg, borderColor: theme.inputBorder }]}>
          <TextInput style={[styles.input, { color: theme.text, fontFamily: 'Urbanist_400Regular' }]} value={fullName} onChangeText={setFullName} />
        </View>

        <Text style={[styles.label, { color: theme.text, fontFamily: 'Urbanist_600SemiBold' }]}>Nickname</Text>
        <View style={[styles.inputContainer, { backgroundColor: theme.inputBg, borderColor: theme.inputBorder }]}>
          <TextInput style={[styles.input, { color: theme.text, fontFamily: 'Urbanist_400Regular' }]} value={nickname} onChangeText={setNickname} />
        </View>

        <Text style={[styles.label, { color: theme.text, fontFamily: 'Urbanist_600SemiBold' }]}>Email</Text>
        <View style={[styles.inputContainer, { backgroundColor: theme.inputBg, borderColor: theme.inputBorder }]}>
          <Ionicons name="mail-outline" size={20} color={theme.textTertiary} />
          <TextInput style={[styles.input, { color: theme.text, fontFamily: 'Urbanist_400Regular' }]} value={email} onChangeText={setEmail} keyboardType="email-address" />
        </View>
        ...
        <View style={[styles.inputContainer, { backgroundColor: theme.inputBg, borderColor: theme.inputBorder }]}>
          ...
          <TextInput style={[styles.input, { color: theme.text, fontFamily: 'Urbanist_400Regular' }]} value={phone} onChangeText={setPhone} keyboardType="phone-pad" />
        </View>
